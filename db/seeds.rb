...
Port.create(address: "123 Main St", city: "New York", country: "United States", latitude: 40.730610, longitude: -73.935242, image_url: "test.jpg", currency: "USD")
Port.create(address: "234 Maple Ave", city: "Boston", country: "United States", latitude: 42.36026, longitude: -71.05728, image_url: "test.jpg", currency: "USD")
Port.create(address: "456 Second Ave", city: "Savannah", country: "United States", latitude: 32.076176, longitude: -81.088371, image_url: "test.jpg", currency: "USD")
...
Port.create(address: "5566 Desert Ave", city: "Casablanca", country: "Morocco", latitude: 33.57375, longitude: -7.59974, image_url: "test.jpg", currency: "MAD")
Port.create(address: "789 Third Pl", city: "Montego Bay", country: "Jamaica", latitude: 18.46887, longitude: -77.92166, image_url: "test.jpg", currency: "JMD")
...
Booking.create(user_id: 1, vessel_id: 1, port_start_id: 1, port_end_id: 5, start_date: "2025-01-01")
Booking.create(user_id: 1, vessel_id: 2, port_start_id: 2, port_end_id: 4, start_date: "2025-01-15")
Booking.create(user_id: 2, vessel_id: 3, port_start_id: 3, port_end_id: 2, start_date: "2025-02-25")
